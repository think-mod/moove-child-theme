...
$THEME->scss = function($theme) {                                                                                                   
    return theme_moovechild_get_main_scss_content($theme);                                                                               
};
...
//$THEME->javascripts = array('course-color'); // for JS/jQury in header of page.

//netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.min.css

//require_once($CFG->dirroot . '/theme/moovechild/courseThemeStyle.php');