...
if ($ADMIN->fulltree) {
    ...
    $settings = new theme_boost_admin_settingspage_tabs('themesettingmoovechild', get_string('configtitle', 'theme_moovechild'));
    ...
    */
    ...
    $name = 'theme_moovechild/presetfiles';
    ...
    $name = 'theme_moovechild/loginbgimg';
    ...
    $name = 'theme_moovechild/brandcolor';
    ...
    // We use an empty default value because the default colour should come from the preset.
    $name = 'theme_moovechild/navbarheadercolor';
    ...
    // Variable $navbar-bg.
    // We use an empty default value because the default colour should come from the preset.
    $name = 'theme_moovechild/navbarbg';
    ...
    // We use an empty default value because the default colour should come from the preset.
    $name = 'theme_moovechild/navbarbghover';
    ...
    $name = 'theme_moovechild/coursepresentation';
    ...
    $name = 'theme_moovechild/courselistview';
    ...
    */
    ...
    foreach(array_slice($courses, 1) as $course) { // first course will be the general site
        ...
        $name = 'theme_moovechild/courseColor'.$course->id;
    ...
    */
    ...
    $setting = new admin_setting_scsscode('theme_moovechild/scsspre',
        get_string('rawscsspre', 'theme_moove'), get_string('rawscsspre_desc', 'theme_moove'), '', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Raw SCSS to include after the content.
    $setting = new admin_setting_scsscode('theme_moovechild/scss', get_string('rawscss', 'theme_moove'),
        get_string('rawscss_desc', 'theme_moove'), '', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Google analytics block.
    $name = 'theme_moovechild/googleanalytics';
    ...
    */
    ...
    $name = 'theme_moovechild/disablefrontpageloginbox';
    ...
    $name = 'theme_moovechild/disableteacherspic';
    ...
    $name = 'theme_moovechild/headerimg';
    ...
    // Bannerheading.
    $name = 'theme_moovechild/bannerheading';
    ...
    // Bannercontent.
    $name = 'theme_moovechild/bannercontent';
    ...
    $name = 'theme_moovechild/displaymarketingbox';
    ...
    // Marketing1icon.
    $name = 'theme_moovechild/marketing1icon';
    ...
    // Marketing1heading.
    $name = 'theme_moovechild/marketing1heading';
    ...
    $name = 'theme_moovechild/marketing1subheading';
    ...
    // Marketing1content.
    $name = 'theme_moovechild/marketing1content';
    ...
    // Marketing1url.
    $name = 'theme_moovechild/marketing1url';
    ...
    // Marketing2icon.
    $name = 'theme_moovechild/marketing2icon';
    ...
    // Marketing2heading.
    $name = 'theme_moovechild/marketing2heading';
    ...
    $name = 'theme_moovechild/marketing2subheading';
    ...
    // Marketing2content.
    $name = 'theme_moovechild/marketing2content';
    ...
    // Marketing2url.
    $name = 'theme_moovechild/marketing2url';
    ...
    // Marketing3icon.
    $name = 'theme_moovechild/marketing3icon';
    ...
    // Marketing3heading.
    $name = 'theme_moovechild/marketing3heading';
    ...
    $name = 'theme_moovechild/marketing3subheading';
    ...
    // Marketing3content.
    $name = 'theme_moovechild/marketing3content';
    ...
    // Marketing3url.
    $name = 'theme_moovechild/marketing3url';
    ...
    // Marketing4icon.
    $name = 'theme_moovechild/marketing4icon';
    ...
    // Marketing4heading.
    $name = 'theme_moovechild/marketing4heading';
    ...
    $name = 'theme_moovechild/marketing4subheading';
    ...
    // Marketing4content.
    $name = 'theme_moovechild/marketing4content';
    ...
    // Marketing4url.
    $name = 'theme_moovechild/marketing4url';
    ...
    $name = 'theme_moovechild/sliderenabled';
    ...
    $name = 'theme_moovechild/sliderfrontpage';
    ...
    $name = 'theme_moovechild/slidercount';
    ...
    for ($sliderindex = 1; $sliderindex <= $slidercount; $sliderindex++) {
        ...
        $name = 'theme_moovechild/sliderimage' . $sliderindex;
    ...
    // Enable or disable Slideshow settings.
    $name = 'theme_moovechild/numbersfrontpage';
    ...
    $name = 'theme_moovechild/sponsorsfrontpage';
    ...
    $name = 'theme_moovechild/sponsorstitle';
    ...
    $name = 'theme_moovechild/sponsorssubtitle';
    ...
    $name = 'theme_moovechild/sponsorscount';
    ...
    for ($sponsorsindex = 1; $sponsorsindex <= $sponsorscount; $sponsorsindex++) {
        ...
        $name = 'theme_moovechild/sponsorsimage' . $sponsorsindex;
        ...
        $name = 'theme_moovechild/sponsorsurl' . $sponsorsindex;
    ...
    $name = 'theme_moovechild/clientsfrontpage';
    ...
    $name = 'theme_moovechild/clientstitle';
    ...
    $name = 'theme_moovechild/clientssubtitle';
    ...
    $name = 'theme_moovechild/clientscount';
    ...
    for ($clientsindex = 1; $clientsindex <= $clientscount; $clientsindex++) {
        ...
        $name = 'theme_moovechild/clientsimage' . $clientsindex;
        ...
        $name = 'theme_moovechild/clientsurl' . $clientsindex;
    ...
    */
    ...
    $name = 'theme_moovechild/getintouchcontent';
    ...
    $name = 'theme_moovechild/facebook';
    ...
    // Linkdin url setting.
    $name = 'theme_moovechild/linkedin';
    ...
    $name = 'theme_moovechild/instagram';
    ...
    $name = 'theme_moovechild/whatsapp';
    ...
    $name = 'theme_moovechild/topfooterimg';
    ...
    // Disable bottom footer.
    $name = 'theme_moovechild/disablebottomfooter';
    ...
    $name = 'theme_moovechild/forumcustomtemplate';
    ...
    // Header setting.
    $name = 'theme_moovechild/forumhtmlemailheader';
    ...
    // Footer setting.
    $name = 'theme_moovechild/forumhtmlemailfooter';
